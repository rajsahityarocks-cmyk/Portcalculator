...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
        ...
        <section className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-white rounded-2xl shadow p-4">
            <div className="flex items-center justify-between">
              ...
              <button onClick={downloadCSV} className="inline-flex items-center gap-2 text-sm px-3 py-1.5 rounded-xl border hover:opacity-90">
      ...
      <footer className="max-w-5xl mx-auto p-4 text-center text-xs text-gray-600">
        Built for quick estimates. Not financial advice.
      </footer>
    </div>
  );
}
